...
<body>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="assets-dashboard/app-profile.html">Ruangan</a></li>
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Barang</a>
                                <ul aria-expanded="false">
                                    <li><a href="assets-dashboard/email-compose.html">Barang</a></li>
                                    <li><a href="assets-dashboard/email-inbox.html">Kategori Barang</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="assets-dashboard/ui-accordion.html">Data Peminjaman</a></li>
                            <li><a href="assets-dashboard/ui-alert.html">Data Pengembalian</a></li>
                            <li><a href="assets-dashboard/ui-badge.html">History</a></li>
                        </ul>
                    </li>
                    ...
                    <ul aria-expanded="false">
                    <li><a href="assets-dashboard/ui-accordion.html">Data User</a></li>
                </ul>
            </li>
                </ul>
            </div>
    ...
    ***********************************-->
    ...
    <script src="assets-dashboard/js/quixnav-init.js"></script>
    <script src="assets-dashboard/js/custom.min.js"></script>

    <script src="assets-dashboard/vendor/chartist/js/chartist.min.js"></script>

    <script src="assets-dashboard/vendor/moment/moment.min.js"></script>
    <script src="assets-dashboard/vendor/pg-calendar/js/pignose.calendar.min.js"></script>


    <script src="assets-dashboard/js/dashboard/dashboard-2.js"></script>
    <!-- Circle progress -->
